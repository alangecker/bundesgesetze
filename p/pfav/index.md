...
7.  Hier sind die Teile der erfolgsabhängigen RfB anzugeben, die gemäß §
    237 Absatz 1 Satz 1 in Verbindung mit § 140 Absatz 4 und § 212 Absatz
    1 VAG gebildet worden sind.


8.  Unter diesem Posten ist die im Posten 6.a) enthaltene, nach Kapitel 5
...
7.  Hierunter fallen
    ...
    a)  Abschreibungen auf erworbene oder selbst erstellte Sachanlagen für
        betriebliche Zwecke, einschl. auf eigengenutzte Gebäude,
...
9.  Berechnung der Vollzeiteinheiten (VZE) in Spalte 4: Summe der
...
2.  Die Gesamtbeträge für die einzelnen Posten in Spalte 01 müssen mit den
    jeweiligen Bilanzwerten übereinstimmen.


3.  In Spalte 01 ist der Bilanzwert der Kapitalanlagen abzüglich der
...
6.  In diesem Bilanzposten enthaltene vorausgezahlte Versorgungsleistungen
    können in Spalte 02, alle übrigen sonstigen Forderungen dürfen nur in
...
2.  Die Nachweisung 804 stellt eine vereinfachte Nachweisung 803
    ...
    Nachweisung 804 in Zeile 18 inhaltlich zusammengefasst. Die Positionen
    der Zeilen 03, 05, 06, 07, 08, 09, 11, 12 und 13 auf Seite 2 der
    Nachweisung 803 sind in anderer Aufteilung in den Zeilen 21, 23, 24,
...
2.  In allen Datenfeldern sind grundsätzlich kumulierte Werte einzutragen,
...
3.  Die Davon-Vermerke in den Zeilen 05 und 06 beziehen sich auf die
...
6.  Einschließlich der Aufwendungen für beendete Pensionsfondsverträge und
    Versorgungsverhältnisse.
...
**1.** **Allgemeines**
    ...
    Nachweisungen gemäß den §§ 5 bis 9 sowie 11 sind entweder elektronisch
    oder auf Papierformularen einzureichen.
...
3.1 Formblätter und Nachweisungen auf Papierformularen werden in der BaFin
    ...
    BaFin (siehe Tz. 3.4) – auf Endlospapier mit EDV-Druckern zu
    erstellen.
...
3.4 Im Datenteil des Einzelformulars dürfen die in den Formularen der
    Anlagen 4 und 5 enthaltenen Operationszeichen (+, –, =, (), <) sowie
...
3.6.2.1 Im Feld „Pb“ ist für Kontrollzwecke der zur Register-Nummer des PF
...
3.6.2.3 Das Feld „Herkunft des PFG“ kennzeichnet das in den Formblättern und
    Nachweisungen dargestellte Pensionsfondsgeschäft. Bei der
    Kennzeichnung ist Folgendes zu beachten:


3.6.2.3.1 Die Kennzahlen für das Feld „Herkunft des PFG“ ergeben sich aus Anlage
    1\. Das Feld befindet sich auf dem Formblatt 810 und der Nachweisung
    842\.


3.6.2.3.2 In die Kopfzeile des Formblatts 810 und der Nachweisung 842 sind für
...
3.6.2.3.3 Die verschiedenen Ausfertigungen der Formblätter 810 sowie der
    ...
    Fall 1: Das PFG hat nur eine Herkunft, d. h., es besteht entweder nur
    aus inländischem oder ausländischem PFG mit der Folge, dass Herkunft
...
3.6.3.2 Absolute Beträge sind ohne Dezimalstellen anzugeben. Unter 0,5 Euro
    ...
    TsdEuro)                    ist abzurunden und ansonsten aufzurunden.
    Cent-Beträge oder Beträge unter 1 TsdEuro können jedoch auch unter
    Verzicht auf die Rundung einfach weggelassen werden, sofern die Auf-
    und Abrundung einen unverhältnismäßig hohen Aufwand verursachen würde.
...
3.6.3.5 Datenfelder, in denen der berichtende Pensionsfonds keine Angaben
    machen kann, müssen frei bleiben. Eine zusätzliche Kennzeichnung z. B.
    durch einen Strich darf nicht erfolgen.
...
3.6.4.2 Negative Vorzeichen sind auch einzusetzen, wenn hohe Erträge aus der
    ...
    wenn pensionsfondstechnische Erträge aus dem in Rückversicherung
    gegebenen Pensionsfondsgeschäft (Anteile der Rückversicherer an diesen
